...
c.execute("CREATE TABLE MUSIC (name text , category text, music_name text)")
c.execute("CREATE TABLE BOOKS (name text , category text, books_name text)")
c.execute("CREATE TABLE MOVIES (name text , category text, movies_name text)")
c.execute("CREATE TABLE INS_PEOPLE (name text , people text)")
conn.commit()
'''
